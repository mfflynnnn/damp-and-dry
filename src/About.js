              ...
              <div className="col-12">
                ...
                <div className="row perks">
                  <div className="col-12 col-lg-4">
                    ...
                    <p>
                      Damp & Dry July is for anyone who wants to feel good and
                      take care of their health and wellness. The health
                      benefits from reducing or eliminating alcohol from your
                      diet are many, and can include better sleep, clearer skin,
                      weight loss, improved mental health, and more.
                    </p>
                    <hr></hr>
                  </div>
                  <div className="col-12 col-lg-4">
                  ...
                  <div className="col-12 col-lg-4">
                    ...
                    <p>
                      ...
                      lonely. Enjoy the ritual of a night out with friends,
                      while remaining in control and in your element. Feel clear
                      headed the next day, skip the regrets, and remember the
